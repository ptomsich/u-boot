...
static int ehci_usb_probe(struct udevice *dev)
{
	...
	/* On the A64-uQ7 (Lynx) we could do without opening OHCI for HCI1,
	 * as the on-module hubs will do the transaction translation.
	 *
	 * Until this is converted to the driver model (and can finally go
	 * away), it won't do any harm to have this here...
	 */
